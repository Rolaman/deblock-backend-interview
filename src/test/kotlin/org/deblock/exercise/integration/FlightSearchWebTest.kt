...
class FlightSearchWebTest {
    ...
    fun search_success_withRealApiSimulation() {
        val origin = "FRA"
        val destination = "LHR"
        val departureDate = "2023-10-01"
        val returnDate = "2023-10-02"
    ...
    private fun setupCrazyAirMocks() {
        crazyAirServer.stubFor(
            post(urlEqualTo("/crazy-air/search"))
                ...
                .withRequestBody(matchingJsonPath("$.departureDate", equalTo("2023-10-01")))
                .withRequestBody(matchingJsonPath("$.returnDate", equalTo("2023-10-02")))
                .willReturn(
                    aResponse()
                        .withStatus(200)
                            ...
                            [
                                {
                                    ...
                                    "departureDate": "2023-10-01T10:00:00",
                                    "arrivalDate": "2023-10-01T12:00:00"
                                }
                            ]
                            """.trimIndent()
                        )
    ...
    private fun setupToughJetMocks() {
        toughJetServer.stubFor(
            post(urlEqualTo("/tough-jet/search"))
                ...
                .withRequestBody(matchingJsonPath("$.outboundDate", equalTo("2023-10-01")))
                .withRequestBody(matchingJsonPath("$.inboundDate", equalTo("2023-10-02")))
                .willReturn(
                    aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                            ...
                            [
                                {
                                    ...
                                    "outboundDateTime": "2023-10-01T10:00:00Z",
                                    "inboundDateTime": "2023-10-01T12:00:00Z"
                                }
                            ]
                            """.trimIndent()
                        )
